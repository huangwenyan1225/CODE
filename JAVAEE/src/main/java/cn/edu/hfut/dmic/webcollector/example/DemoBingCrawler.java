...
//                    pageNum, rank + 1, page.doc().title(), page.doc().outerHtml(),depth,referer);
            ArrayList<String> attrs = page.getAttrs("img[src]", "abs:src");
            String line="";
    ...
    public static void main(String[] args) throws Exception {
        ...
        DemoBingCrawler crawler = new DemoBingCrawler("十大美女",10);
        crawler.start();
